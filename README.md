...
<h2 id="folder-structure"> :small_orange_diamond: Структура проекта</h2>
    ...
    │   ├── model_4.keras            # Обученная модель (коллекция 4)            
    │   └── model_5.h5               # Обученная модель (коллекция 5)
    |
...
- **Python 3.9+** — язык программирования, на котором написан Telegram - бот
...
- **OpenCV** — библиотека для обработки и анализа изображений
- **Pydantic** — библиотека для валидации и управления данными
...
- 📁 [Датасеты (Яндекс Диск)](https://disk.yandex.ru/d/ZMdzPGthYJdx5w)
...
- [Видео-демонстрация работы бота](https://drive.google.com/file/d/1yiXJ_PzVEevlAcIh1yh_5hBn-P17FouF/view?usp=drive_link)
- [Все документы по работе над проектом (Google Drive)](https://drive.google.com/drive/u/1/folders/1SqW4DWadmEfX75dRZIVHQgjVDyDJr1gC)
