...
<p>
Для обучения моделей был **самостоятельно собран кастомный датасет** изображений картин из коллекций музея **«Эрмитаж-Урал»**.  
Всего в проекте используется **4 коллекции**, каждая из которых представлена в виде отдельной папки с собственным набором изображений.
...
Модели обучаются **отдельно для каждой коллекции**, что позволяет повысить точность классификации внутри определённого набора работ.
</p>
